<x-guest-layout>
    @if (session('status'))
        <div
            class="mb-6 px-4 py-3 rounded-xl bg-sky-50 text-sky-900 border border-sky-200 text-sm animate-fade-in">
    ...
    <div class="max-w-md mx-auto">
        <form method="POST" action="{{ route('login') }}"
            class="bg-white/90 backdrop-blur-sm border border-black/10 shadow-xl rounded-3xl px-8 py-10">
            ...
            <div class="mb-5">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                    ...
                    class="w-full px-4 py-3 rounded-xl border border-gray-200
                           focus:border-[#15a5ed] focus:ring-4 focus:ring-[#15a5ed]/20
                ...
                <div class="flex justify-between items-center mb-2 ml-1">
                    ...
                    {{-- @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}"
                           class="text-xs font-semibold text-[#15a5ed] hover:text-[#118bc8]">
                            Forgot password?
                        </a>
                    @endif --}}
                </div>
            ...
            <div class="flex items-center mb-6 ml-1">
                <input id="remember_me" type="checkbox" name="remember"
                    class="rounded border-gray-300 text-[#15a5ed] focus:ring-[#15a5ed]/30 transition duration-150 ease-in-out">
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('register') }}"
                            class="text-[#15a5ed] font-bold hover:text-[#118bc8] transition-colors">
                            Create an account
                        </a>
                    </p>
                </div>
