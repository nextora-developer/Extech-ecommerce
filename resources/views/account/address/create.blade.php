    ...
    <div class="bg-[#F4F8FD] min-h-screen py-6 md:py-10">
        <div class="max-w-7xl5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:hidden flex items-center justify-center relative mb-6">
                {{-- Back Button --}}
                <a href="{{ route('account.address.index') }}" class="absolute left-0 p-2 text-gray-500 hover:text-[#15A5ED] transition">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <main class="lg:col-span-3 space-y-5">
                    ...
                    <section class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Fill in your shipping / delivery address details.
                                </p>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('account.address.store') }}" class="space-y-5">
                            @csrf
                            ...
                            {{-- Row 3: Postcode + City + State + Country --}}
