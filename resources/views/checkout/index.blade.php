<x-app-layout>
    <div class="bg-[#f7f7f9] py-10">
        <div class="max-w-7xl5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center uppercase space-x-2 text-sm text-gray-500 mb-6">
                ...
                <a href="{{ route('cart.index') }}" class="hover:text-[#15a5ed] transition-colors">Shopping Cart</a>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                    ...
                    <div class="lg:col-span-3 space-y-4">
                                                ...
                                                <button type="button" data-address-choice
                                                    ...
                                                    @if ($isDefault)
                                                        <div class="absolute top-3 right-3">
                                                            <span
                                                                class="px-2.5 py-1 rounded-full bg-[#15a5ed] text-white text-[10px] font-bold uppercase tracking-widest shadow-sm">
                                                                Default
                                                            </span>
                                                        </div>
                                                    @endif
                        ...
                        <section class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                            ...
                            <div class="px-6 py-5 border-b border-gray-50 flex items-center gap-3">
                                <div
                                    class="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-900">
                        ...
                        {{ $defaultCode === $method->code ? 'border-gray-900 bg-gray-50' : 'border-gray-100 bg-white hover:border-gray-300' }}">

                                                <div class="flex items-center h-5">
                                                    <input type="radio" name="payment_method"
                                                        value="{{ $method->code }}" @checked($defaultCode === $method->code)
                                                        class="payment-radio h-5 w-5 text-gray-900 border-gray-300 focus:ring-gray-900 cursor-pointer">
                                                </div>
                                                ...
                                                @if ($isOnlineTransfer)
                                                    <div class="hidden sm:flex items-center gap-1 opacity-70">
                                                        <div
                                                            class="px-2 py-1 rounded bg-white border border-gray-200 text-[10px] font-bold text-gray-700">
                                                            Online Banking
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                @if ($isOnlineTransfer)
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex gap-4">
                                                            <span
                                                                class="flex-shrink-0 w-6 h-6 rounded-full bg-gray-900 text-white text-xs font-bold flex items-center justify-center">1</span>
                                                        ...
                                                        @if ($method->duitnow_qr_path)
                                                            <div class="flex gap-4">
                                                                <span
                                                                    class="flex-shrink-0 w-6 h-6 rounded-full bg-gray-900 text-white text-xs font-bold flex items-center justify-center">2</span>
                                                        ...
                                                        <div class="flex gap-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    ...
                                                                    You will be redirected to secure payment page to
                                                                    complete your payment.
                                                                    Supported methods include FPX, cards, and e-wallets.
                                                                </p>
                            ...
                            <div class="p-5">
                                ...
                                <div
                                    ...
                                    @foreach ($items as $item)
                                        ...
                                        <div class="flex gap-3 group mt-1">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h3
                                                    class="text-sm font-medium text-gray-900 line-clamp-1 group-hover:text-gray-900 transition-colors">
                                                    {{ $p->name }}
                                                </h3>
                                ...
                                <div class="space-y-3 bg-gray-50 rounded-2xl p-4 border border-gray-100">
                                    ...
                                    <div class="border-t border-gray-200 my-1 pt-3 flex justify-between items-center">
                                        ...
                                        <div class="text-right">
                                            <span class="text-xl font-black text-gray-900" data-total-text>
                                                RM {{ number_format($subtotal, 2) }}
                                            </span>
                                ...
                                <div class="mt-5">
                                    ...
                                    <textarea name="remark" rows="3" placeholder="Eg: Please ship together / Leave at doorstep / Send as gift"
                                        class="w-full text-sm rounded-2xl border border-gray-200 focus:border-gray-900 focus:ring-2 focus:ring-gray-900/20 px-4 py-3 resize-none">{{ old('remark') }}</textarea>
                                </div>

                                {{-- Checkout Button --}}
                                <div class="mt-6">
                                    <button type="submit"
                                        class="w-full relative group overflow-hidden bg-gray-900 text-white px-4 py-4 rounded-2xl font-bold text-base shadow-xl hover:bg-black hover:shadow-black/20 transition-all duration-300 active:scale-[0.98]">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function activateAddress(btn) {
                ...
                if (stateSelect) {
                    ...
                    Array.from(stateSelect.options).forEach(opt => {
                        if (opt.value === stateName) found = true;
                    });

                    stateSelect.value = found ? stateName : '';
            ...
            if (buttons.length) {
                buttons.forEach(btn => {
                    btn.addEventListener('click', () => activateAddress(btn));
                });

                const defaultBtn = Array.from(buttons).find(b => b.dataset.default === '1');
                if (defaultBtn) activateAddress(defaultBtn);
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function refreshPaymentUI() {
                ...
                details.forEach(detail => {
                    if (detail.dataset.code === activeCode) detail.classList.remove('hidden');
    ...
    <script>
        document.querySelector('form')?.addEventListener('submit', function(e) {
            ...
            if (method === 'online_transfer' && file && !file.value) {
                e.preventDefault();
