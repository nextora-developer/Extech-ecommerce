<x-app-layout>
    <section class="bg-[#FAF9F6] min-h-screen flex items-center justify-center py-20 px-4">
        <div class="w-full max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {{-- Card --}}
            <div class="bg-white rounded-[2rem] border border-gray-100 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] p-10 sm:p-14 text-center relative overflow-hidden">
                
                {{-- Subtle Background Accent --}}
                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#D4AF37]/40 to-transparent"></div>

                {{-- Icon --}}
                <div class="flex justify-center mb-8">
                    <div class="relative">
                        <div class="absolute inset-0 rounded-full bg-[#D4AF37] blur-xl opacity-10 animate-pulse"></div>
                        <div class="relative w-20 h-20 rounded-full bg-white border border-[#D4AF37]/20 flex items-center justify-center shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-[#D4AF37]" fill="none"
                    ...
                    <div class="flow-root">
                        <ul role="list" class="divide-y divide-gray-100 border-y border-gray-50">
                            ...
                            <li class="py-4 flex items-center justify-between">
                                ...
                                <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $order->status === 'paid' ? 'text-emerald-700 bg-emerald-50' : 'text-amber-700 bg-amber-50' }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('shop.index') }}"
                        class="flex justify-center items-center rounded-full bg-white px-6 py-4 text-sm font-semibold text-gray-600 border border-gray-200 transition-all hover:border-[#D4AF37]/50 hover:text-[#D4AF37] active:scale-[0.98]">
                        Return to Shop
                    </a>
                </div>
            </div>
