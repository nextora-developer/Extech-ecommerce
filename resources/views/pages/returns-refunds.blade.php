    ...
    <section class="bg-[#FAF9F6] min-h-screen pb-20">
        ...
        <div class="bg-white border-b border-gray-100">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                <h2 class="text-xs font-bold uppercase tracking-[0.3em] text-[#8f6a10] mb-3">Customer Care</h2>
                ...
                <p class="text-base text-gray-500 max-w-2xl mx-auto leading-relaxed">
                    Not quite right? We're here to help. Our goal is to make your return process as smooth as your purchase.
                </p>
                ...
                <div class="mt-10 flex flex-wrap items-center justify-center gap-2">
                    @foreach ([
                        ...
                        ['id'=>'exceptions','label'=>'Exclusions'],
                    ] as $j)
                        <a href="#{{ $j['id'] }}"
                           class="inline-flex items-center px-4 py-2.5 rounded-2xl bg-white border border-gray-100 shadow-sm
                                  text-xs font-bold text-gray-700 hover:border-[#D4AF37] hover:text-[#8f6a10] transition-all">
                            {{ $j['label'] }}
                        </a>
                    @endforeach
                </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
            ...
            <div id="eligibility" class="scroll-mt-24">
                <div class="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach([
                            ['t' => 'Original Condition', 'd' => 'Items must be unworn, unwashed, and with all original tags attached.'],
                            ['t' => 'Packaging', 'd' => 'Must include the original box and protective materials.'],
                            ['t' => 'Timeframe', 'd' => 'Request within 7 days of receiving your parcel.'],
                            ['t' => 'Proof of Purchase', 'd' => 'Order ID or digital receipt must be presented.'],
                        ] as $rule)
                            <div class="flex gap-4">
                                <div class="mt-1 shrink-0 w-5 h-5 rounded-full bg-green-50 text-green-600 flex items-center justify-center">
            ...
            <div id="process" class="scroll-mt-24 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    @foreach([
                        ['t' => '1. Contact Support', 'd' => 'Message us on WhatsApp with your Order ID and photos of the item.'],
                        ['t' => '2. Pack & Ship', 'd' => 'Once approved, pack your item securely and send it back to our hub.'],
                        ['t' => '3. Quality Check', 'd' => 'We inspect the item within 48 hours of arrival to verify its condition.']
                    ] as $step)
                        <div class="bg-white border border-gray-100 p-6 rounded-3xl">
                            <h4 class="text-sm font-bold text-[#8f6a10] mb-2">{{ $step['t'] }}</h4>
            ...
            {{-- Section: Refunds --}}
            <div id="refunds" class="scroll-mt-24 bg-gray-900 rounded-[2.5rem] p-10 text-white shadow-xl relative overflow-hidden">
                <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4">Refund Policy</h3>
                    <p class="text-gray-400 text-sm leading-relaxed mb-8 max-w-xl">
                        Once your return is inspected and approved, your refund will be processed back to your original payment method. 
                    </p>
                    <div class="inline-flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                        <div class="w-10 h-10 rounded-full bg-[#D4AF37]/20 flex items-center justify-center text-[#D4AF37]">
                ...
                {{-- Decorative element --}}
                <div class="absolute right-0 top-0 -mr-16 -mt-16 w-64 h-64 bg-[#D4AF37]/10 rounded-full blur-3xl"></div>
            </div>
        </div>
    </section>
