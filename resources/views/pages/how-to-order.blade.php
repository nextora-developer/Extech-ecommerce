    ...
    <section class="bg-[#FAF9F6] min-h-screen pb-20">
        ...
        <div class="bg-white border-b border-gray-100">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 text-center">
                <h2 class="text-xs font-bold uppercase tracking-[0.4em] text-[#8f6a10] mb-4">Customer Guide</h2>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
            ...
            <div id="steps" class="scroll-mt-24 mb-24">
                <div class="flex items-end justify-between gap-6 mb-10">
                    ...
                    <span
                        class="hidden sm:inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold bg-white border border-[#D4AF37]/30 text-[#8f6a10] shadow-sm">
                        6 Steps Process
                    </span>
                </div>
                ...
                @php
                    $steps = [
                        ...
                        [
                            ...
                            'desc' =>
                                'Choose between Online Transfer or Direct Payment to complete your order.',
                        ...
                        [
                            'title' => 'Order Updates',
                            'desc' =>
                                'You’ll receive an email confirmation. We will provide tracking info once dispatched.',
                        ...
                        @foreach ($steps as $i => $s)
                            <div class="relative flex flex-col md:flex-row gap-6 group">
                                ...
                                <div class="shrink-0 relative z-10">
                                    <div
                                        class="w-16 h-16 rounded-2xl bg-white border border-gray-100 shadow-sm flex items-center justify-center group-hover:border-[#D4AF37]/50 transition-colors duration-300">
                                        <div
                                            class="w-12 h-12 rounded-xl bg-[#D4AF37]/10 flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-[#8f6a10]"
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap items-center justify-between gap-3 mb-3">
                                        <h4 class="text-xl font-bold text-gray-900">{{ $i + 1 }}.
                                            {{ $s['title'] }}</h4>
                                        <span
                                            class="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-[#FAF9F6] border border-gray-100 text-gray-400">
                                            Stage {{ $i + 1 }}
                                        </span>
                                    </div>
                                    ...
                                    <div
                                        class="flex items-start gap-3 p-4 rounded-2xl bg-orange-50/50 border border-orange-100/50">
                                        <span class="text-orange-600 mt-0.5">
                                        ...
                                        <p class="text-sm text-orange-800/80">
                                            <span class="font-bold text-orange-900">Pro tip:</span> {{ $s['tip'] }}
                                        </p>
                                    </div>
                                </div>
                            </div>
