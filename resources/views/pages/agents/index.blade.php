<x-app-layout>
    <section class="bg-[#F5FAFE] min-h-screen py-12 md:py-20">
        <div class="max-w-5xl mx-auto px-4">

            {{-- Header --}}
            <div class="text-center mb-12">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-[#15A5ED]/10 rounded-full mb-4">
                    <svg class="w-8 h-8 text-[#15A5ED]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-base text-gray-500 mt-3 max-w-md mx-auto">
                    Verify whether an Extech Studio representative is officially authorised before making payment or
            ...
            <div class="relative group mb-10">
                <form method="GET"
                    class="relative z-10 flex items-center flex-wrap sm:flex-nowrap
                           bg-white rounded-2xl shadow-xl shadow-sky-100/50 border border-sky-100
                           p-2 focus-within:ring-4 focus-within:ring-[#15A5ED]/10 transition-all">
                    ...
                    <button
                        class="w-full sm:w-auto mt-2 sm:mt-0
                               ...
                               hover:bg-[#0f8fd0] transition-all active:scale-95 shadow-lg shadow-[#15A5ED]/20">
                        Verify Now
                    </button>
                </form>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                ...
                <div class="bg-white p-8 rounded-3xl border border-sky-100 shadow-sm">
                    <h3
                        ...
                        <span class="w-1 h-4 bg-[#15A5ED] rounded-full"></span>
                        Status Definitions
                    </h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-4">
                            <div class="w-2 h-2 rounded-full bg-[#15A5ED] mt-1.5 shrink-0"></div>
                            <div>
                ...
                <div class="bg-white p-8 rounded-3xl border border-sky-100 shadow-sm">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center gap-3 text-base text-gray-600">
                            <svg class="w-4 h-4 text-[#15A5ED] shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
            ...
            <div class="mt-12 bg-white rounded-[2rem] border border-sky-100 shadow-sm overflow-hidden">
                {{-- Header --}}
                <div class="px-8 pt-10 pb-8 text-center md:text-left">
                    <h3 class="text-xl md:text-2xl font-black text-gray-900 tracking-tight">
                        Official Contact <span class="text-[#15A5ED]">&</span> Payment Safety
                    </h3>
                ...
                <div class="px-8 pb-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        {{-- Official WhatsApp --}}
                        <div
                            class="group rounded-2xl border border-sky-100 bg-sky-50/40 p-6 transition-all hover:bg-white hover:shadow-md">
                            ...
                            <div class="text-xl font-bold text-gray-900">011-5689 8898</div>
                        ...
                        <div
                            class="group rounded-2xl border border-sky-100 bg-sky-50/40 p-6 transition-all hover:bg-white hover:shadow-md">
                            <div class="flex items-center gap-3 mb-4">
                                <div class="p-2 bg-[#15A5ED]/10 rounded-lg text-[#15A5ED]">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="text-xl font-bold text-gray-900 break-all">cs.extechstudio@gmail.com</div>
                        ...
                        <div
                            class="md:col-span-1 rounded-2xl border-2 border-[#15A5ED]/20 bg-white p-6 shadow-lg shadow-[#15A5ED]/5 relative">
                            <div
                                class="absolute top-4 right-4 uppercase text-[10px] font-black bg-[#15A5ED] text-white px-2 py-1 rounded">
                                Official
                            </div>
                            <div class="flex items-center gap-3 mb-4 text-[#15A5ED]">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="text-lg font-black text-gray-900 uppercase">Extech Studio</div>
                        ...
                        {{-- Safe Payment Rule --}}
                        <div class="md:col-span-1 rounded-2xl bg-[#0F172A] p-6 text-white shadow-xl">
                            ...
                            <p class="mt-4 text-sm text-slate-400 leading-tight">
                    ...
                    <div class="mt-8 flex items-center justify-between border-t border-sky-100 pt-6">
                        <p class="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em]">
                            Verified Security Data &bull; Last updated: March 2026
                        </p>
                        <div class="flex gap-2">
                            <div class="w-2 h-2 rounded-full bg-[#15A5ED] shadow-[0_0_8px_rgba(21,165,237,0.5)]"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- Report Bar --}}
            <div
                class="mt-8 bg-[#0F172A] rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-slate-900/10">
                <div>
                    <h4 class="text-white font-bold text-xl">Found a suspicious agent?</h4>
                    <p class="text-slate-400 text-base">Help us keep the community safe by reporting fraud.</p>
                </div>
                <div class="flex gap-3 shrink-0">
                    <a href="mailto:cs.extechstudio@gmail.com"
                        class="px-5 py-2.5 bg-red-600 text-white rounded-xl text-sm font-bold hover:bg-red-700 transition-all">
                        Email Report
                    </a>
                    <a href="https://wa.me/601156898898"
                        class="px-5 py-2.5 bg-[#15A5ED] text-white rounded-xl text-sm font-bold hover:bg-[#0f8fd0] transition-all">
                        WhatsApp
                    </a>
                </div>
            </div>
            ...
            <p class="text-xs text-gray-400 mt-10 text-center uppercase tracking-[0.2em] font-medium">
                Extech Studio Verification System &bull; Live Agent Status &bull; Secure Business Verification
            </p>
